...
<head>
    ...
    <title>MedSyst — Regular Queue</title>
    @include('partials._styles')
    <style>
        .queue-header-band { background: var(--teal); padding: 10px 2rem; display: flex; align-items: center; gap: 10px; }
        ...
        .q-num-badge { display: inline-flex; align-items: center; justify-content: center; min-width: 52px; height: 36px; border-radius: 8px; background: var(--teal-bg); color: var(--teal-deep); font-family: 'DM Serif Display', serif; font-size: 1.1rem; font-weight: 700; }
...
<body>
<div class="shell">
    @include('partials._staff_sidebar', ['active' => 'queue.regular'])
    ...
    <div class="main">
        ...
        <div class="queue-header-band">
            <svg fill="none" viewBox="0 0 24 24" stroke="#fff" stroke-width="2" style="width:14px;height:14px;flex-shrink:0;"><path stroke-linecap="round" stroke-linejoin="round" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"/></svg>
            <p>REGULAR QUEUE <span>— Stable patients served in order of arrival.</span></p>
        </div>
        ...
        <div class="content">
            <div class="page-header">
                <div class="page-header-left">
                    <h1>Regular Queue</h1>
                    <p>{{ $queues->total() ?? 0 }} stable patient(s) waiting</p>
                </div>
            ...
            <div class="table-card">
                ...
                <div style="overflow-x:auto;">
                    <table class="data-table" id="queueTable">
                        ...
                        @endphp
                        <tr class="row-normal" data-status="{{ $queue->status }}" data-name="{{ strtolower($fullName) }}">
                            <td><span class="q-num-badge">{{ $queue->queue_number }}</span></td>
                            <td>
                                <div class="patient-cell">
                                    <div class="pt-avatar teal">{{ $initials }}</div>
                                    <div>
                        ...
                        <tr><td colspan="7">
                            <div class="empty-state">
                                ...
                                <p>No patients in the regular queue right now.</p>
                            </div>
                        </td></tr>
                        @endforelse
                        </tbody>
